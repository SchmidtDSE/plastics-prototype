...
[ ! -e third_party/theme-textmate-css.js ] && wget https://cdnjs.cloudflare.com/ajax/libs/ace/1.32.3/theme-textmate-css.min.js -O third_party/theme-textmate-css.js
